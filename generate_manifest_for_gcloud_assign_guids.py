...
from bdcat_ingest import add_new_drs_uri
...
def process_row(od, bucket, row, test_mode):
	...
	if ('file_name' not in row or 'md5sum' not in row):
		print("manifest file missing of the following required fields: file_name, md5sum")		
		exit()
