...
def main():
	...
	# process file
	od = OrderedDict()
	od = generate_dict_from_gcs_bucket(args.bucket, args.study_id, args.consent_group)
...
def parse_args():
	parser = argparse.ArgumentParser(description='Generate TSV file for gcs Bucket.')
